...
EFI_TDX_METADATA  mTdShimMetadata = {
  ...
  {
    {  // BFV
      .DataOffset     = FixedPcdGet32(PcdPayloadRawDataOffset),
      .RawDataSize    = FixedPcdGet32(PcdPayloadSize) + FixedPcdGet32(PcdBfvSize),
      .MemoryAddress  = (UINTN)FixedPcdGet32(PcdPayloadBase),
      .MemoryDataSize = (UINTN)FixedPcdGet32(PcdPayloadSize) + FixedPcdGet32(PcdBfvSize),
